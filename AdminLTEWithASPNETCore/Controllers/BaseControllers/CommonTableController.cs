...
namespace AdminLTEWithASPNETCore.Controllers.Apis
{
    ...
    public class CommonTableController<T> : ControllerBase where T : class
    {
        /// <summary>
        /// The log
        /// </summary>
        protected ILogger<CommonTableController<T>> _log;

        /// <summary>
        /// The providers
        /// </summary>
        protected ICommonTableRepository<T> _db;
        ...
        public CommonTableController(ICommonTableRepository<T> repository, ILogger<CommonTableController<T>> log)
        {
            _log = log;
            _db = repository;
        }
